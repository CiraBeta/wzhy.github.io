...
echo:
echo:
call :_color2 %_Green% "                                   欢迎使用   " 
echo:       ______________________________________________________________
echo:
echo:                 激活方法:
echo:
echo:             [1] HWID      ^|  Windows           ^|   -
echo:             [2] KMS38     ^|  Windows           ^|   -
echo:             [3] KMS       ^|  Windows/Office    ^|   -
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "         " %_RED% "                                不属于Microsoft Corporation"
choice /C:12345678 /N
set _erl=%errorlevel%

if %_erl%==8 exit /b
if %_erl%==7 start http://wzhy323.free1.asia & goto :Aha
